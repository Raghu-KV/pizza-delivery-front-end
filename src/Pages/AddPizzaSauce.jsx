...
function AddPizzaSauce() {
  ...
  const validationSchema = yup.object({
    pizzaSauce: yup.string().required("Pizza Base is required"),
    price: yup
      .number()
  ...
  const formSubmit = async (values) => {
    const responce = await fetch(`${BACK_END_URL}/addCustomSauce`, {
      method: "POST",
